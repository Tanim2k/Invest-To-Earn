            ...
            <div class="row z-depth-3">
                <div class="col-sm-4 bg-info rounded-left">
                    <div class="card-block text-center text-white">
                        ...
                        <h2 class="font-weight-bold mt-4"> oasik</h2>
                ...
                <div class="col-sm-8 bg-white rounded-right">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <h6 class=" text-muted">zhoasik999@gmail.com</h6>
                        </div>
                        <div class="col-sm-6">
                            <p class="font-weight-bold">UserName:</p>
                            <h6 class=" text-muted">oasik</h6>
                        </div>
                        <div class="col-sm-6">
                            <p class="font-weight-bold">Phone:</p>
                            <h6 class="text-muted">01733728094</h6>
                        </div>
                        <div class="col-sm-6">
                            <p class="font-weight-bold">NID:</p>
                            <h6 class="text-muted">200000022222</h6>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <h6 class="text-muted">2/11/1999</h6>
                        </div>
                        <div class="col-sm-2">
